...
{% capture images %}
    {{ site.url }}/assets/res/2023-05-03-effay-starter-pack/3-levis.jpg
    {{ site.url }}/assets/res/2023-05-03-effay-starter-pack/3-zara.jpg
{% endcapture %}
...
{% capture images %}
    {{ site.url }}/assets/res/2023-05-03-effay-starter-pack/7-abercrombie.jpg
...
{% capture images %}
    {{ site.url }}/assets/res/2023-05-03-effay-starter-pack/8-alpha.jpg
    {{ site.url }}/assets/res/2023-05-03-effay-starter-pack/8-uniqlo.jpg
{% endcapture %}
{% include gallery images=images cols=2 caption="Alpha Industries MA-1 Bomber Jacket Slim Fit, Uniqlo MA-1 Blouson (Women's)" %}
...
<table><tr><td>
<h3>Spring/Summer</h3><ul>
<li>White shirt, blue jeans</li>
<li>White shirt, black trousers</li>
<li>Black shirt, black trousers</li>
<li>Button-down, white shirt, blue jeans</li>
<li>Button-down, black trousers</li>
</ul></td><td>
