...
<details><summary><b>² Oh boy here we go again ▶</b></summary>
<small>Don't worry, this one won't be as bad.</small>

<p>
Soul Chain is geneally considered a pretty bad skill as Invigorate 3 is simply better by almost all metrics. In order for Soul Chain to come out on top, you'll need to baton pass into that persona at least once every 3 turns. This is definitely doable but not very practical, whereas Invigorate 3 will restore SP for simply existing.
</p>
...
<p>
That said, if you're intending to use Tag Team then you're going to use a soma. There aren't many consumable items in the game that are even worth using, let alone conserving. And somas will full heal your SP anyway, so there is little point in using a skill slot to restore SP prior to this.
</p>
...
<p>
This raises another question: how much value does Invigorate 3 give us? It'll just be 7SP on the turn that Joker buffs, and won't activate on the 2nd turn as you'll be attacking with another persona. Contrast this to Spell Master, which will save you 7SP when casting Charge / Concentrate and more than twice that when using Debilitate. Aside from contrived counter-examples, it seems that Spell Master is simply a straight upgrade.
</p>
</details>
