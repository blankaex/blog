...
The manual buffing counterpart to our previous auto-buffer. In P5R, Charge and Concentrate apply to Joker himself, not the persona that casts it. Therefore it's optimal to have a dedicated Charge / Concentrate user to save skill slots on our attackers. As he'll be sitting around for a turn after buffing, we're using Fafnir due to his resistances but you can use whoever you like.

Thermopylae is a party-wide Heat Riser to use when our auto-buffs run out, and the activation condition is met with Attis' Vitality of the Tree trait. We also bring Debilitate for enemy debuffs, and round out with defensive utility. I've opted for Drain Bless / Curse instead of Ali Dance as Fafnir already blocks a bunch of elements, and this gives us insta-kill immunity as an added bonus.
