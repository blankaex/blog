...
<p>
I could go into more detail with the individual stat buffs, the crit buffs, Heat Riser, etc. but I won't because you wouldn't be using those if you cared enough to read until this point. If you want to know about these edge cases then read <a href="https://wikiwiki.jp/persona5r/おすすめ特性">the JP wiki</a>.
</p>
...
<p>
This raises another question: how much value does Invigorate 3 give us? It'll be 7SP on the turn that Joker buffs, but won't activate on the 2nd turn as you'll be attacking with another persona. Contrast this to Spell Master, which will save you 7SP when casting Charge / Concentrate and more than twice that when using Debilitate. Aside from contrived counter-examples, Spell Master is simply a straight upgrade.
</p>
</details>
