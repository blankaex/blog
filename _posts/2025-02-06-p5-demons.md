...
That being said, P5R gives you a lot of tools to completely customise your personas. The simple act of playing around with fusions and achieving "perfect" builds is a big part of what I find enjoyable about Megaten, so here we go. This should also be a useful reference for [pushing high scores on those challenge battles](https://youtu.be/UfTcRSt4iTI).

{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/20250203185133.jpg
{% endcapture %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/1709501033573303.gif
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/alice.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/yoshitsune.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/lucifer.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/satanael.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/trumpeter.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/alilat.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/nebiros.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/belial.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/maria.jpg
{% endcapture %}
{% include gallery images=images %}
...
<li>Positive Thoughts guarantees buffs cast by anyone always last for 5 turns on Joker. However the trade-off is that all buffs cast on teammates <b>except for auto-buffs</b> will only last for 3 turns.</li>
</ol>
</p>
...
<p>
I could go into more detail with the individual stat buffs, the crit buffs, the single-targets like Heat Riser, etc. but I won't because you wouldn't be using those if you cared enough to read until this point anyway. If you want to know about these edge cases then read <a href="https://wikiwiki.jp/persona5r/おすすめ特性">the JP wiki</a>.
</p>

<img src="{{ site.url }}/assets/res/2025-02-06-p5-demons/1623846988871.gif" style="margin-bottom:10px">
</details>

### Fafnir

{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/fafnir.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/1709593904545373.gif
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/izanagi.jpg
{% endcapture %}
{% include gallery images=images %}
...
As usual, boost, amp, and Magic Ability give us `2.0x` and Country Maker doubles this to `4.0x`, easily overwhelming the rest of the competition who all tap out below `2.5x`. InO already resists everything, so we'll use Firm Stance over Ali Dance to bring our damage taken from `1/2` to `1/4`. Did I forget to mention Country Maker? Make that `1/8` damage taken. Then we seal the deal with bless, curse and ailment resistances to complete a persona that can unironically solo the entire game with one button.

### Thanatos

{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/thanatos.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/izanagi-1.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/kaguya.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/tsukiyomi.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/magatsu.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/asterius.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/satanael-1.jpg
{% endcapture %}
{% include gallery images=images %}
...
This is essentially the same as the previous Abaddon gun build, just with a higher damage multiplier and a less disgusting body. Keep in mind that we do drop Pagan Allure for Will of the Sword, as the former doesn't affect gun skills. Also note that Satanael isn't immune to gun damage, so be careful against gun-repel demons... [All seven of them](https://aqiu384.github.io/megaten-fusion-tool/p5r/personas).
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/raoul.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/orpheus-f.jpg
{% endcapture %}
{% include gallery images=images %}
...
{% capture images %}
    {{ site.url }}/assets/res/2025-02-06-p5-demons/ariadne.jpg
{% endcapture %}
{% include gallery images=images %}
...
<details><summary><b>² Soul Chain vs Spell Master ▶</b></summary>
<small><s>oh boy here we go again</s> don't worry, this one won't be as bad</small>
...
<p>
However given the nature of this build and its minor focus on Tag Team, you're likely not going to be sitting around on Ariadne for more than one turn; but you <i>are</i> quite likely (relatively) to be the recipient of a baton pass. Therefore it's quite possible that Soul Chain will be more beneficial, and a 20SP recover is pretty non-trivial.
</p>
