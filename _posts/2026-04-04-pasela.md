...
We figured a web application would be ideal so that it'd work on any device and we wouldn't need to mess with Apple developer certificates and all that other nonsense for our fruit-enjoying friends. astro atually has [a static site framework](https://rubygems.org/gems/weaver) he's developed so I also took the opportunity to give it a crack.
